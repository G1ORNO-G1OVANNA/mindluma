...
export function LoginPage({ onNavigate, onSignup }: LoginPageProps) {
  ...
  return (
    <div className="flex items-center justify-center p-6" style={backgroundStyle}>
      ...
      >
        <h1 className="text-3xl font-medium text-center mb-10 text-slate-900 tracking-tight">Login</h1>
        ...
        <div className="space-y-5">
          ...
          <button
            ...
            style={accentGradient}
          >
            <span className="text-black font-bold uppercase tracking-widest text-sm">Login</span>
          </button>
